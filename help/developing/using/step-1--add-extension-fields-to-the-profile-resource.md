...
1. Fai clic sul pulsante **[!UICONTROL Create]** per creare una nuova risorsa personalizzata.
1. Scegli l’opzione **[!UICONTROL Extend an existing resource]**.
1. Seleziona la risorsa **[!UICONTROL Profile]**.
1. Fai clic su **[!UICONTROL Create]**.
1. Aggiungi il **[!UICONTROL Text]** type **[!UICONTROL Promo code]** con **[!UICONTROL Brand]** ID nei campi delle risorse.
