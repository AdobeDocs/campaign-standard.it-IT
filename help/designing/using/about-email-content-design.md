...
1. È inoltre possibile nascondere un componente. Quando si verifica questa opzione, il componente corrispondente verrà nascosto quando viene visualizzato su un dispositivo mobile.
