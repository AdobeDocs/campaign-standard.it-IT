...
>[!IMPORTANT]
>
>Per accedere ai registri di consegna, devi avere un [Ruolo amministratore](../../administration/using/users-management.md#functional-administrators) e far parte della **[!UICONTROL All]** [unità organizzativa](../../administration/using/organizational-units.md). <!--If you would like to restrict access for a particular user or group of users, do not link it to **[!UICONTROL All]** units.-->
