...
+ Profili e audience {#profiles-and-audiences}
   ...
   + Gestione delle sottoscrizioni {#managing-subscriptions}
      ...
      + [Monitoraggio delle sottoscrizioni](audiences/using/monitoring-subscriptions.md)
      + [Conferma dell’iscrizione a un servizio](audiences/using/confirming-subscription-to-a-service.md)
   + Informazioni sui processi di opt-in e opt-out {#understanding-opt-in-and-opt-out-processes}
      + [Informazioni sull'opt-in e l'opt-out in Campaign](audiences/using/about-opt-in-and-opt-out-in-campaign.md)
      + [Gestione del consenso e del rifiuto nella campagna](audiences/using/managing-opt-in-and-opt-out-in-campaign.md)
      + [Identificazione dei profili di rifiuto per una consegna](audiences/using/identifying-opt-out-profiles-for-a-delivery.md)
+ Canali di comunicazione {#communication-channels}
   + I canali di comunicazione {#about-communication-channels}
      + [Individuazione dei canali di comunicazione](channels/using/discovering-communication-channels.md)
      + [Passaggi chiave per l'invio di un messaggio](channels/using/key-steps-to-send-a-message.md)
   ...
   + Messaggi e-mail {#email-messages}
      ...
      + [Creazione di un messaggio e-mail in più lingue](channels/using/creating-a-multilingual-email.md)
   ...
   + Pagine di destinazione {#landing-pages}
      ...
      + [Limitazioni per la pagina di destinazione](channels/using/landing-page-limitations.md)
      ...
      + [Archiviazione dei dati e riconciliazione](channels/using/data-storage-and-reconciliation.md)
      + [Impostazione di un doppio processo di consenso](channels/using/setting-up-a-double-opt-in-process.md)
      + [Informazioni sulla progettazione del contenuto della pagina di destinazione](channels/using/about-landing-page-content-design.md)
      ...
      + [Definizione del contenuto dinamico in una pagina di destinazione](channels/using/defining-dynamic-content-in-a-landing-page.md)
...
+ Integrazione con Adobe Cloud {#integrating-with-adobe-cloud}
   ...
   + Utilizzo di Campaign e Audience Manager o del servizio di base Persone {#working-with-campaign-and-audience-manager-or-people-core-service}
      + [Informazioni sull'integrazione di Campaign-Audience Manager o dei servizi di base Persone](integrating/using/about-campaign-audience-manager-or-people-core-service-integration.md)
   ...
   + Utilizzo di Campaign e Analytics per dispositivi mobili {#working-with-campaign-and-analytics-for-mobile}
      + [Informazioni sull'integrazione dei dati Campaign-Points (Punti di interesse per le campagne)](integrating/using/about-campaign-points-of-interest-data-integration.md)
      + [Configurazione dell’integrazione dei dati Campaign-Points of Interest](integrating/using/configuring-campaign-points-of-interest-data-integration.md)
      + [Personalizzazione dei messaggi della campagna con i dati dei punti di interesse](integrating/using/personalizing-campaign-messages-with-point-of-interest-data.md)
...
+ Gestione di processi e dati {#managing-processes-and-data}
   + Flussi di lavoro e gestione dei dati {#about-workflows-and-data-management}
      ...
      + [Scoprire i flussi di lavoro](automating/using/discovering-workflows.md)
      + [Principi operativi del flusso di lavoro](automating/using/workflow-operating-principles.md)
      + [Interfaccia flusso di lavoro](automating/using/workflow-interface.md)
   ...
   + Attività di targeting {#targeting-activities}
      ...
      + [Leggi il pubblico](automating/using/read-audience.md)
   ...
   + Attività di esecuzione {#execution-activities}
      ...
      + [Forchetta](automating/using/fork.md)
      + [AND-join](automating/using/and-join.md)
      + [Scheduler](automating/using/scheduler.md)
      + [Aspetta](automating/using/wait.md)
   ...
   + Attività del canale {#channel-activities}
      ...
      + [Distribuzione delle notifiche push](automating/using/push-notification-delivery.md)
      + [Spedizione diretta](automating/using/direct-mail-delivery.md)
   ...
   + Attività di gestione dei dati {#data-management-activities}
      ...
      + [Trasferisci file](automating/using/transfer-file.md)
...
+ Sviluppo {#developing}
   ...
   + Aggiunta o estensione di una risorsa {#adding-or-extending-a-resource}
      + [Passaggi chiave per aggiungere una risorsa](developing/using/key-steps-to-add-a-resource.md)
   ...
   + Caso di utilizzo: Estensione dell'API {#use-case--extending-the-api}
      ...
      + [Passaggio 1: Aggiunta di campi di estensione alla risorsa del profilo](developing/using/step-1--add-extension-fields-to-the-profile-resource.md)
   ...
   + Casi di utilizzo: Estensione delle risorse {#use-cases--extending-resources}
      ...
      + [Estensione delle sottoscrizioni a una risorsa applicazione](developing/using/extending-the-subscriptions-to-an-application-resource.md)
+ Amministrazione {#administrating}
   ...
   + Utenti e protezione {#users-and-security}
   ...
   + Configurazione dei canali {#configuring-channels}
      + [Informazioni sulla configurazione del canale](administration/using/about-channel-configuration.md)
   ...
   + Utilizzo delle regole di tipologia {#working-with-typology-rules}
      ...
      + [Regole di fatica](administration/using/fatigue-rules.md)
   ...
   + Impostazioni applicazione {#application-settings}
      ...
      + [Mappature di destinazione in Campaign](administration/using/target-mappings-in-campaign.md)
