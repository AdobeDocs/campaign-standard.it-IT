...
+ Note sulla versione {#release-notes}
   ...
   + Versioni precedenti {#previous-releases}
      + [Note sulla versione 2023](rn/using/release-notes-2023.md)
      + [Note sulle versioni 2022](rn/using/release-notes-2022.md)
...
+ Amministrazione {#administrating}
   ...
   + Configurazione dei canali per dispositivi mobili {#configuring-mobile}
      ...
      + [Prossime modifiche del canale di notifica push](administration/using/push-technote.md)
