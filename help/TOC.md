...
# Documentazione di Adobe Campaign Standard {#using}
...
+ Integrazione con altre soluzioni {#integrating-with-adobe-cloud}
  ...
  + Campaign e Microsoft Dynamics 365 {#campaign-and-microsoft-dynamics-365}
    ...
    + Configurare l’app di integrazione {#configure-integration-tool}
      ...
      + [Migrazione delle credenziali da JWT a OAuth server-to-server](integrating/using/d365-acs-self-service-app-migrate-credentials.md)
...
+ Amministrazione {#administrating}
  ...
  + Configurazione dei canali {#configuring-channels}
    ...
    + {hide-from-toc}[Linee guida CNIL sui pixel di tracciamento delle e-mail](administration/using/cnil-pixel-tracking.md)
  ...
  + Configurazione dei canali mobili {#configuring-mobile}
    ...
    + [Modifiche del canale di notifica push](administration/using/push-technote.md)
