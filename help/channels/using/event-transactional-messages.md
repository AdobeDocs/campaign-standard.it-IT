...
In questo esempio verrà illustrato come personalizzare un messaggio di transazione aggiungendo tre campi definiti al momento della creazione dell&#39;evento [a](../../administration/using/configuring-transactional-messaging.md#use-case--configuring-an-event-to-send-a-transactional-message): nome, ultimo prodotto consultato, importo totale del carrello.

A tal fine, [inserisci un campo di personalizzazione](../../designing/using/personalization.md#inserting-a-personalization-field) nel contenuto del messaggio.
...
1. Scorri **[!UICONTROL Context]** > **[!UICONTROL Real-time event]** > **[!UICONTROL Event context]** per ottenere i campi di personalizzazione: nome, ultimo prodotto consultato, importo totale del carrello.
...
### Passaggio 2: Compilare l&#39;elenco di prodotti {#populating-the-product-listing}
