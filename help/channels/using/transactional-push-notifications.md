...
1. Quando create la configurazione dell&#39;evento, selezionate il canale **[!UICONTROL Mobile application]** e la dimensione di targeting **[!UICONTROL Real-time event]** (vedete [Creazione di un evento](../../channels/using/configuring-transactional-event.md#creating-an-event)).
...
1. Arricchite il contenuto dei messaggi transazionali se desiderate utilizzare informazioni aggiuntive provenienti  database Adobe Campaign (consultate [Arricchimento dell&#39;evento](../../channels/using/configuring-transactional-event.md#enriching-the-transactional-message-content)).
...
1. Integrare l’evento nel sito Web (consultate Integrare l’attivazione dell’evento (../../channels/using/getting-started-with-transactional-msg.md#integration-event-trigger)).
...
1. Utilizzando l&#39;API REST di Adobe Campaign Standard , inviate un evento a un token di registrazione (ABCDEF123456789), utilizzando un&#39;applicazione mobile (WeFlight), su Android (gcm), contenente i dati di imbarco:
   ...
   Per ulteriori informazioni sull&#39;integrazione dell&#39;attivazione di un evento in un sistema esterno, vedete Attivazione di un evento (../../channels/using/getting-started-with-transactional-msg.md#integration-event-trigger).
...
1. Quando create la configurazione dell&#39;evento, selezionate il canale **[!UICONTROL Mobile application]** e la dimensione di targeting **[!UICONTROL Profile]** (vedete [Creazione di un evento](../../channels/using/configuring-transactional-event.md#creating-an-event)).
...
1. Create un arricchimento per collegare l&#39;evento alla risorsa **[!UICONTROL Profile]** (consultate [Arricchimento dell&#39;evento](../../channels/using/configuring-transactional-event.md#enriching-the-transactional-message-content)). La creazione di un arricchimento è obbligatoria quando si utilizza una dimensione di targeting **[!UICONTROL Profile]**.
1. [Visualizzate l’anteprima e pubblicate l’evento](../../channels/using/publishing-transactional-event.md#previewing-and-publishing-the-event).
