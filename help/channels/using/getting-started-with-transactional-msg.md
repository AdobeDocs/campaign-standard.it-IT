...
Possono essere messaggi di benvenuto, conferme di spedizione ordine, aggiornamenti della password, ecc.
...
[Messaggi transazionali di evento](../../channels/using/event-transactional-messages.md) indirizzati a un evento.

* I messaggi relativi alle transazioni degli eventi non contengono informazioni sul profilo.

* Non sono compatibili con le [regole di affaticamento](../../sending/using/fatigue-rules.md) (anche nel caso di un arricchimento con profili).
...
[Messaggi transazionali di profilo](../../channels/using/profile-transactional-messages.md) indirizzati ai profili dal database di marketing di Campaign.
...
* Questo passaggio deve essere eseguito da un utente con diritti di amministrazione [](../../administration/using/users-management.md#functional-administrators).
...
* Questo passaggio può essere eseguito da qualsiasi utente di marketing con [diritti di accesso utente standard](../../administration/using/users-management.md#basic-users).

Per ulteriori informazioni sulla modifica e la pubblicazione di un messaggio transazionale, vedere [Messaggi transazionali evento](../../channels/using/event-transactional-messages.md).
...
Per ulteriori informazioni sull&#39;integrazione dell&#39;evento nel sito Web, vedere [Integrazione del sito](../../administration/using/configuring-transactional-messaging.md#integrating-the-triggering-of-the-event-in-a-website).
