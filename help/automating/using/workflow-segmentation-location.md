...
1. In **[!UICONTROL Activities]** > **[!UICONTROL Targeting]**, trascina e rilascia una [Query](../../automating/using/query.md) attività ![](assets/query.png).
...
1. Trascina e rilascia una [Segmentazione](../../automating/using/segmentation.md) e fai doppio clic su di essa.
