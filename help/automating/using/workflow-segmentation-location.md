...
1. In **[!UICONTROL Activities]** > **[!UICONTROL Targeting]**, trascinare un&#39;attività [Query](../../automating/using/query.md) ![](assets/query.png).
...
1. Trascinare un&#39;attività [Segmentazione](../../automating/using/segmentation.md) e fare doppio clic su di essa.
