...
1. L’editor di query consente di filtrare gli elementi da esportare. Per ulteriori informazioni, consulta la sezione [Modifica delle query](../../automating/using/editing-queries.md#creating-queries).
