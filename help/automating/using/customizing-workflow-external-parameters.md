...
* ![](assets/extsignal_expression_editor.png): modificare le espressioni combinando variabili e funzioni (vedere [](../../automating/using/advanced-expression-editing.md)).
