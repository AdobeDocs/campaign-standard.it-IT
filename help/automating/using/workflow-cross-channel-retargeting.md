...
# Flusso di lavoro di destinazione per l’invio di una nuova distribuzione a utenti non aperti{#retargeting-delivery-to-non-openers}
...
1. Trascinare e rilasciare un messaggio [Invio e-mail](../../automating/using/email-delivery.md) dopo ogni segmento.
...
## Targeting non-openers in un&#39;attività di query{#targeting-non-openers-in-a-query-activity}

1. In **[!UICONTROL Activities]** > **[!UICONTROL Execution]**, trascinare un&#39;attività [Wait](../../automating/using/wait.md).
...
1. Per creare il layout del proprio sms, fare clic su **[!UICONTROL Email Designer]**.
1. Inserisci elementi o seleziona un modello esistente.
