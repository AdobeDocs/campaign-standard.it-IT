...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> I clic univoci vengono calcolati utilizzando i concetti di ThetaSketch. Per ulteriori informazioni, consulta questa <a href="https://experienceleague.adobe.com/docs/campaign-standard/using/reporting/about-reporting/troubleshooting.html#unique-open-clicks-no-match">esempio</a>.<br /> </td> 
   <td> </td> 
  </tr> 
  <tr> 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   <td> Aperture univoche<br /> </td> 
   <td> @uniqueopens<br /> </td> 
   <td> Aperture univoche viene calcolato utilizzando i concetti ThetaSketch di RecipientIds univoci. Per ulteriori informazioni, consulta questa <a href="https://experienceleague.adobe.com/docs/campaign-standard/using/reporting/about-reporting/troubleshooting.html#unique-open-clicks-no-match">esempio</a>.<br /> </td> 
  </tr> 
  <tr> 
   <td> Impression<br /> </td> 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> @uniqueimpressions<br /> </td> 
   <td> @unique(@count(status=view))<br /> </td> 
   <td> Per <span class="uicontrol">Eseguire il targeting degli utenti in base al loro profilo Campaign (inAppProfile)</span> template, user = ID destinatario.<br /> Per <span class="uicontrol">Eseguire il targeting per tutti gli utenti di un’app mobile (inAppBroadcast)</span> e <span class="uicontrol">Eseguire il targeting degli utenti in base al loro profilo mobile (inApp)</span> template, user = MC Id o equivalente che rappresenta una combinazione univoca di utente, app mobile e dispositivo.<br /> </td> 
  </tr> 
  <tr> 
