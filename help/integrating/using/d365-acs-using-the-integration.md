...
Quando un attributo di rinuncia viene modificato in Campaign, viene riflesso in Dynamics 365 se hai selezionato la configurazione di rinuncia **Unidirezionale (da Campaign a Microsoft Dynamics 365)** o **Bidirezionale** e se hai mappato correttamente tale attributo.

## Esperienza utente con Microsoft Dynamics 365

In uscita, i seguenti eventi di marketing e-mail vengono inviati da Campaign a Dynamics 365 e visualizzati nella visualizzazione Timeline di Microsoft Dynamics 365 come attività personalizzate:
...
>[!NOTE]
>
>Per visualizzare questi eventi è necessario installare l’app **Adobe Campaign for Microsoft Dynamics 365** in AppSource nell’istanza Microsoft Dynamics 365. [Ulteriori informazioni](../../integrating/using/d365-acs-configure-d365.md#install-appsource-app).
...
### Flusso degli eventi di marketing e-mail{#email-marketing-event-flow}
...
>[!NOTE]
>
>Nell’interfaccia utente dell’applicazione di integrazione, i casi d’uso **Unidirezionale (da Microsoft Dynamics 365 a Campaign)** e **Bidirezionale** sono configurati in un flusso di lavoro di rinuncia separato. [Ulteriori informazioni](../../integrating/using/d365-acs-self-service-app-data-sync.md#opt-in-out-wf).
>
>Il caso d’uso **Unidirezionale (da Campaign a Microsoft Dynamics 365)** di rinuncia è un’eccezione; è configurato all’interno del flusso di lavoro Ingresso (contatto con profilo).
