...
6. Verifica se le nuove credenziali funzionano
   ...
   * Monitora i flussi di lavoro per alcuni minuti per assicurarti che funzionino correttamente. Puoi anche controllare i dati in Adobe Campaign Standard e Microsoft Dynamics 365 per assicurarti che vengano sincronizzati correttamente.
