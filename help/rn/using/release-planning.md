...
Informazioni dettagliate su questa versione sono disponibili nelle [Note preliminari sulla versione](../../rn/using/e-release-notes.md) al momento in cui vengono rilasciati gli aggiornamenti in Stage.
