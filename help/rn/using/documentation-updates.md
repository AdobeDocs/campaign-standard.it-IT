...
Una nota è stata inviata per specificare che l’invio di bozze utilizzando la sostituzione del profilo aggiungerà dei record ai registri dei profili selezionati. [Maggiori informazioni](../../sending/using/testing-messages-using-target.md)
