...
La preparazione della sezione di invio è stata spostata. [Leggi tutto](../../sending/using/preparing-the-send.md)
...
È stato eseguito l’aggiornamento della documentazione sulla configurazione di un’app mobile, unitamente alle pagine correlate, in modo da riflettere l’ammortamento di SDK V4. [Ulteriori informazioni](https://aep-sdks.gitbook.io/docs/version-4-sdk-end-of-support-faq)
...
È stato aggiunto un nuovo caso d’uso che descrive come creare un gruppo di controllo utilizzando un flusso di lavoro all’interno di Campaign Standard. [Ulteriori informazioni](../../automating/using/workflow-control-group.md)
...
Integrazione con Microsoft Dynamics 365 (GA) - [Ulteriori informazioni](../../integrating/using/working-with-campaign-standard-and-microsoft-dynamics-365.md)
...
È stato aggiunto un nuovo esempio che illustra come inviare un messaggio e-mail contenente i dati aggiuntivi che sono stati recuperati da un’attività di caricamento file. [Ulteriori informazioni](../../automating/using/load-file.md#example-2-email-with-enriched-fields)
...
È stato creato un set di nuovi articoli della guida relativi all’implementazione e all’utilizzo del connettore Microsoft Dynamics 365. Al momento questa funzione presenta solo una disponibilità limitata.[Ulteriori informazioni](../../integrating/using/working-with-campaign-standard-and-microsoft-dynamics-365.md)
...
È stata aggiunta una tabella di compatibilità per il reporting dinamico per una migliore comprensione della compatibilità tra dimensioni e metriche. [Ulteriori informazioni](https://docs.campaign.adobe.com/doc/standard/en/Technotes/dynamic_report_compatibility.pdf)
...
È stata aggiornata la pagina Funzioni obsolete e rimosse. [Ulteriori informazioni](https://helpx.adobe.com/it/campaign/kb/acs-deprecated-and-removed-features.html)
...
Sono state inserite informazioni sulla nuova opzione presente nelle attività Query ( [Ulteriori informazioni](../../automating/using/query.md)) e Segmentation ( [Ulteriori informazioni](../../automating/using/segmentation.md)), che consente di aggiungere una transizione in uscita al termine dell’attività, in caso di mancato recupero dei dati.
...
A partire dalla versione 18.7, la guida Utenti e sicurezza è stata aggiornata per riflettere la rimozione della funzionalità dell’unità geografica per le nuove istanze Campaign Standard, oltre che delle istanze esistenti prive di unità geografiche. [Ulteriori informazioni](https://helpx.adobe.com/it/campaign/kb/acs-deprecated-and-removed-features.html)
...
Nella sezione dell’attività query è stato aggiunto un esempio su come eseguire il targeting dei profili che hanno selezionato un collegamento specifico all’interno di una consegna. [Ulteriori informazioni](../../automating/using/query.md#targeting-profiles-who-clicked-a-specific-link-)
...
È ora disponibile una nuova opzione che consente di migliorare le prestazioni quando definisci numerosi dati aggiuntivi in una **[!UICONTROL Query]** . [Ulteriori informazioni](../../automating/using/query.md)
...
È stata rimossa la sezione che include l’elenco delle autorizzazioni. [Ulteriori informazioni](https://docs.campaign.adobe.com/doc/standard/en/Technotes/AdobeCampaign-ACSRights.pdf) (PDF).
...
Sono state aggiunte informazioni sulla modalità di invio di una consegna in base ai fusi orari degli utenti nell’ambito di un flusso di lavoro ricorrente. [Ulteriori informazioni](../../automating/using/push-notification-delivery.md#sending-a-recurring-push-notification-with-a-workflow)
...
Sono state aggiornate le istruzioni per configurare l’integrazione con Audience Manager o con il servizio core People. [Ulteriori informazioni](../../integrating/using/provisioning-and-configuring-integration-with-audience-manager-or-people-core-service.md)
