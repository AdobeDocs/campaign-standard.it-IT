...
Aggiunta una nuova pagina alle limitazioni della pagina di destinazione. [Leggi tutto](../../channels/using/landing-page-limitations.md)
...
La documentazione [](https://docs.campaign.adobe.com/doc/standard/en/api/ACS_API.html) REST API è stata aggiornata:
...
Aggiunta una sezione nella documentazione API relativa ai filtri **** personalizzati. [Leggi tutto](https://docs.campaign.adobe.com/doc/standard/en/api/ACS_API.html#filtering)
...
Le funzionalità dei gruppi API GDPR consentono l'elaborazione automatica delle richieste GDPR. [Leggi tutto](https://docs.campaign.adobe.com/doc/standard/en/api/ACS_API.html#gdpr-api)
...
Attivazione attività segnale API - [Leggi tutto](https://docs.campaign.adobe.com/doc/standard/en/api/ACS_API.html#triggering-a-signal-activity)
...
Nuova sezione dedicata alla gestione del flusso di lavoro tramite l'API. [Leggi tutto](https://docs.campaign.adobe.com/doc/standard/en/api/ACS_API.html#workflows-and-api)

Nuova sezione dedicata alle chiavi primarie e all'utilizzo di un business ID come chiave nell'API. [Leggi tutto](https://docs.campaign.adobe.com/doc/standard/en/api/ACS_API.html#primary-key)

Informazioni aggiunte sui filtri semplici e multipli nell'API. [Leggi tutto](https://docs.campaign.adobe.com/doc/standard/en/api/ACS_API.html#filtering)
...
Abbiamo riprogettato la documentazione API per sviluppatori con nuove informazioni e snippet di codice per migliorare l'esperienza utente. [Leggi tutto](https://docs.campaign.adobe.com/doc/standard/en/api/ACS_API.html)
...
API di messaggistica transazionale - [Leggi tutto](https://docs.campaign.adobe.com/doc/standard/en/api/ACS_API.html)
...
Utilizzo delle API: è stato aggiunto un caso [di utilizzo di estensione](../../developing/using/about-extending-the-api.md) API. Consultate anche la documentazione [](https://docs.campaign.adobe.com/doc/standard/en/api/ACS_API.html)API.
