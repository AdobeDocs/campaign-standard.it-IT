...
* Scopri come [progettare regole](../../sending/using/fatigue-rules.md#examples) di affaticamento tramite un set di esempi
* Scopri come creare regole di [tipologia](../../sending/using/about-typology-rules.md)
* Utilizza le regole [del](../../sending/using/filtering-rules.md) filtro per migliorare il pubblico dei messaggi
