...
Campaign Standard offre diversi strumenti per incrementare il database di marketing. Questa sezione descrive i vari metodi che potete utilizzare per inserire i dati in Campaign, con riferimenti alle documentazione dedicata.
...
Questi contatti sono quindi visibili nell' **[!UICONTROL Profiles]** elenco e possono essere indirizzati alle campagne di marketing.
