...
La creazione o la modifica della mappatura del target è possibile per soddisfare esigenze specifiche. In ogni caso, la dimensione di targeting deve corrispondere sempre ai profili (tabella **[!UICONTROL nms:recipient]**). Per ulteriori informazioni sulle dimensioni targeting, consulta [questa pagina](../../automating/using/query.md#targeting-dimensions-and-resources).
