...
context-tags: extAccountEmail,panoramica;emailConfig,main;ruleSet,overview;delivery,properties,open
internal: n
snippet: y
...
In questa sezione viene illustrato l'elenco dei parametri disponibili nella schermata delle proprietà di un modello [e-mail o](../../start/using/about-templates.md)e-mail.
...
Ccn e-mail è attivato nel modello [di](../../start/using/about-templates.md)e-mail tramite un'opzione dedicata:
