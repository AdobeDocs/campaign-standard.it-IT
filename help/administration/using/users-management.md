...
Gli amministratori possono gestire gli utenti di Admin Console. Gli utenti vengono quindi sincronizzati automaticamente con Adobe Campaign. For more on this, refer to the [Admin console](https://helpx.adobe.com/enterprise/using/users.html) documentation.
...
* [Amministratori funzionali](../../administration/using/users-management.md#functional-administrators): tra tutti gli utenti dell'organizzazione, sono i più tecnici.
* [Utenti avanzati](../../administration/using/users-management.md#advanced-users): configurano tutti gli elementi che gli esperti di marketing devono inviare e monitorare le loro consegne.
* [Utenti di base](../../administration/using/users-management.md#basic-users): sono gli addetti al marketing che personalizzano, distribuiscono e monitorano le campagne.
...
Per aggiungere un utente all'istanza, devi prima crearlo nell'Admin Console prima di modificarlo in Adobe Campaign Standard.
...
1. Controllate il gruppo di protezione dell'utente. Here, you can see that the user has been assigned the **[!UICONTROL Administrators]** security group.

   >[!Note]
   >
   >I gruppi di protezione possono essere rimossi o aggiunti solo a un utente in Admin Console.
