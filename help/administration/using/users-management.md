...
* [Video sulla gestione delle autorizzazioni](https://helpx.adobe.com/campaign/kt/acs/using/acs-user-access-rights-feature-video-use.html) utente
...
* [Gestire i modelli](../../start/using/about-templates.md): gestisci i tuoi modelli per preconfigurare alcuni parametri delle tue attività di marketing in base alle tue esigenze.
