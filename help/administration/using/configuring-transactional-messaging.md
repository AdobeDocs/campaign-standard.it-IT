...
* Il messaggio transazionale corrispondente viene creato automaticamente. See [Getting started with transactional messaging](../../channels/using/getting-started-with-transactional-msg.md).
